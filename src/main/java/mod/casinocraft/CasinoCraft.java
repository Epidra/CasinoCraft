...
public class CasinoCraft {
    ...
    //         event.accept(CasinoKeeper.RULEBOOK_1_1);
    //         event.accept(CasinoKeeper.RULEBOOK_2_1);
    //         event.accept(CasinoKeeper.RULEBOOK_2_2);
    //         event.accept(CasinoKeeper.RULEBOOK_3_1);
    //         event.accept(CasinoKeeper.RULEBOOK_3_2);
    //         event.accept(CasinoKeeper.RULEBOOK_3_3);
    //         event.accept(CasinoKeeper.RULEBOOK_4_1);
    //         event.accept(CasinoKeeper.RULEBOOK_4_2);
    //         event.accept(CasinoKeeper.RULEBOOK_5_1);
    //         event.accept(CasinoKeeper.RULEBOOK_5_2);
    //         event.accept(CasinoKeeper.RULEBOOK_6_1);
    //         event.accept(CasinoKeeper.RULEBOOK_6_2);
    //         event.accept(CasinoKeeper.RULEBOOK_7_0);
    //     }
    // }
