...
public class CasinoKeeper {
    ...
    // ----- Card Tables ----- //
    public static final RegistryObject<Block> CARDTABLE_BASE_WHITE      = registerB("cardtable_base_white",      () -> new BlockCardTableBase(Blocks.IRON_BLOCK, DyeColor.WHITE),      ItemGroup.TAB_DECORATIONS);
    public static final RegistryObject<Block> CARDTABLE_BASE_ORANGE     = registerB("cardtable_base_orange",     () -> new BlockCardTableBase(Blocks.IRON_BLOCK, DyeColor.ORANGE),     ItemGroup.TAB_DECORATIONS);
    public static final RegistryObject<Block> CARDTABLE_BASE_MAGENTA    = registerB("cardtable_base_magenta",    () -> new BlockCardTableBase(Blocks.IRON_BLOCK, DyeColor.MAGENTA),    ItemGroup.TAB_DECORATIONS);
    public static final RegistryObject<Block> CARDTABLE_BASE_LIGHT_BLUE = registerB("cardtable_base_light_blue", () -> new BlockCardTableBase(Blocks.IRON_BLOCK, DyeColor.LIGHT_BLUE), ItemGroup.TAB_DECORATIONS);
    public static final RegistryObject<Block> CARDTABLE_BASE_YELLOW     = registerB("cardtable_base_yellow",     () -> new BlockCardTableBase(Blocks.IRON_BLOCK, DyeColor.YELLOW),     ItemGroup.TAB_DECORATIONS);
    public static final RegistryObject<Block> CARDTABLE_BASE_LIME       = registerB("cardtable_base_lime",       () -> new BlockCardTableBase(Blocks.IRON_BLOCK, DyeColor.LIME),       ItemGroup.TAB_DECORATIONS);
    public static final RegistryObject<Block> CARDTABLE_BASE_PINK       = registerB("cardtable_base_pink",       () -> new BlockCardTableBase(Blocks.IRON_BLOCK, DyeColor.PINK),       ItemGroup.TAB_DECORATIONS);
    public static final RegistryObject<Block> CARDTABLE_BASE_GRAY       = registerB("cardtable_base_gray",       () -> new BlockCardTableBase(Blocks.IRON_BLOCK, DyeColor.GRAY),       ItemGroup.TAB_DECORATIONS);
    public static final RegistryObject<Block> CARDTABLE_BASE_LIGHT_GRAY = registerB("cardtable_base_light_gray", () -> new BlockCardTableBase(Blocks.IRON_BLOCK, DyeColor.LIGHT_GRAY), ItemGroup.TAB_DECORATIONS);
    public static final RegistryObject<Block> CARDTABLE_BASE_CYAN       = registerB("cardtable_base_cyan",       () -> new BlockCardTableBase(Blocks.IRON_BLOCK, DyeColor.CYAN),       ItemGroup.TAB_DECORATIONS);
    public static final RegistryObject<Block> CARDTABLE_BASE_PURPLE     = registerB("cardtable_base_purple",     () -> new BlockCardTableBase(Blocks.IRON_BLOCK, DyeColor.PURPLE),     ItemGroup.TAB_DECORATIONS);
    public static final RegistryObject<Block> CARDTABLE_BASE_BLUE       = registerB("cardtable_base_blue",       () -> new BlockCardTableBase(Blocks.IRON_BLOCK, DyeColor.BLUE),       ItemGroup.TAB_DECORATIONS);
    public static final RegistryObject<Block> CARDTABLE_BASE_BROWN      = registerB("cardtable_base_brown",      () -> new BlockCardTableBase(Blocks.IRON_BLOCK, DyeColor.BROWN),      ItemGroup.TAB_DECORATIONS);
    public static final RegistryObject<Block> CARDTABLE_BASE_GREEN      = registerB("cardtable_base_green",      () -> new BlockCardTableBase(Blocks.IRON_BLOCK, DyeColor.GREEN),      ItemGroup.TAB_DECORATIONS);
    public static final RegistryObject<Block> CARDTABLE_BASE_RED        = registerB("cardtable_base_red",        () -> new BlockCardTableBase(Blocks.IRON_BLOCK, DyeColor.RED),        ItemGroup.TAB_DECORATIONS);
    public static final RegistryObject<Block> CARDTABLE_BASE_BLACK      = registerB("cardtable_base_black",      () -> new BlockCardTableBase(Blocks.IRON_BLOCK, DyeColor.BLACK),      ItemGroup.TAB_DECORATIONS);
    public static final RegistryObject<Block> CARDTABLE_WIDE_WHITE      = registerB("cardtable_wide_white",      () -> new BlockCardTableWide(Blocks.IRON_BLOCK, DyeColor.WHITE),      ItemGroup.TAB_DECORATIONS);
    public static final RegistryObject<Block> CARDTABLE_WIDE_ORANGE     = registerB("cardtable_wide_orange",     () -> new BlockCardTableWide(Blocks.IRON_BLOCK, DyeColor.ORANGE),     ItemGroup.TAB_DECORATIONS);
    public static final RegistryObject<Block> CARDTABLE_WIDE_MAGENTA    = registerB("cardtable_wide_magenta",    () -> new BlockCardTableWide(Blocks.IRON_BLOCK, DyeColor.MAGENTA),    ItemGroup.TAB_DECORATIONS);
    public static final RegistryObject<Block> CARDTABLE_WIDE_LIGHT_BLUE = registerB("cardtable_wide_light_blue", () -> new BlockCardTableWide(Blocks.IRON_BLOCK, DyeColor.LIGHT_BLUE), ItemGroup.TAB_DECORATIONS);
    public static final RegistryObject<Block> CARDTABLE_WIDE_YELLOW     = registerB("cardtable_wide_yellow",     () -> new BlockCardTableWide(Blocks.IRON_BLOCK, DyeColor.YELLOW),     ItemGroup.TAB_DECORATIONS);
    public static final RegistryObject<Block> CARDTABLE_WIDE_LIME       = registerB("cardtable_wide_lime",       () -> new BlockCardTableWide(Blocks.IRON_BLOCK, DyeColor.LIME),       ItemGroup.TAB_DECORATIONS);
    public static final RegistryObject<Block> CARDTABLE_WIDE_PINK       = registerB("cardtable_wide_pink",       () -> new BlockCardTableWide(Blocks.IRON_BLOCK, DyeColor.PINK),       ItemGroup.TAB_DECORATIONS);
    public static final RegistryObject<Block> CARDTABLE_WIDE_GRAY       = registerB("cardtable_wide_gray",       () -> new BlockCardTableWide(Blocks.IRON_BLOCK, DyeColor.GRAY),       ItemGroup.TAB_DECORATIONS);
    public static final RegistryObject<Block> CARDTABLE_WIDE_LIGHT_GRAY = registerB("cardtable_wide_light_gray", () -> new BlockCardTableWide(Blocks.IRON_BLOCK, DyeColor.LIGHT_GRAY), ItemGroup.TAB_DECORATIONS);
    public static final RegistryObject<Block> CARDTABLE_WIDE_CYAN       = registerB("cardtable_wide_cyan",       () -> new BlockCardTableWide(Blocks.IRON_BLOCK, DyeColor.CYAN),       ItemGroup.TAB_DECORATIONS);
    public static final RegistryObject<Block> CARDTABLE_WIDE_PURPLE     = registerB("cardtable_wide_purple",     () -> new BlockCardTableWide(Blocks.IRON_BLOCK, DyeColor.PURPLE),     ItemGroup.TAB_DECORATIONS);
    public static final RegistryObject<Block> CARDTABLE_WIDE_BLUE       = registerB("cardtable_wide_blue",       () -> new BlockCardTableWide(Blocks.IRON_BLOCK, DyeColor.BLUE),       ItemGroup.TAB_DECORATIONS);
    public static final RegistryObject<Block> CARDTABLE_WIDE_BROWN      = registerB("cardtable_wide_brown",      () -> new BlockCardTableWide(Blocks.IRON_BLOCK, DyeColor.BROWN),      ItemGroup.TAB_DECORATIONS);
    public static final RegistryObject<Block> CARDTABLE_WIDE_GREEN      = registerB("cardtable_wide_green",      () -> new BlockCardTableWide(Blocks.IRON_BLOCK, DyeColor.GREEN),      ItemGroup.TAB_DECORATIONS);
    public static final RegistryObject<Block> CARDTABLE_WIDE_RED        = registerB("cardtable_wide_red",        () -> new BlockCardTableWide(Blocks.IRON_BLOCK, DyeColor.RED),        ItemGroup.TAB_DECORATIONS);
    public static final RegistryObject<Block> CARDTABLE_WIDE_BLACK      = registerB("cardtable_wide_black",      () -> new BlockCardTableWide(Blocks.IRON_BLOCK, DyeColor.BLACK),      ItemGroup.TAB_DECORATIONS);

    // ----- Arcades ----- //
    public static final RegistryObject<Block> ARCADE_BASE_WHITE      = registerB("arcade_base_white",      () -> new BlockArcade(     Blocks.IRON_BLOCK, DyeColor.WHITE),      ItemGroup.TAB_DECORATIONS);
    public static final RegistryObject<Block> ARCADE_BASE_ORANGE     = registerB("arcade_base_orange",     () -> new BlockArcade(     Blocks.IRON_BLOCK, DyeColor.ORANGE),     ItemGroup.TAB_DECORATIONS);
    public static final RegistryObject<Block> ARCADE_BASE_MAGENTA    = registerB("arcade_base_magenta",    () -> new BlockArcade(     Blocks.IRON_BLOCK, DyeColor.MAGENTA),    ItemGroup.TAB_DECORATIONS);
    public static final RegistryObject<Block> ARCADE_BASE_LIGHT_BLUE = registerB("arcade_base_light_blue", () -> new BlockArcade(     Blocks.IRON_BLOCK, DyeColor.LIGHT_BLUE), ItemGroup.TAB_DECORATIONS);
    public static final RegistryObject<Block> ARCADE_BASE_YELLOW     = registerB("arcade_base_yellow",     () -> new BlockArcade(     Blocks.IRON_BLOCK, DyeColor.YELLOW),     ItemGroup.TAB_DECORATIONS);
    public static final RegistryObject<Block> ARCADE_BASE_LIME       = registerB("arcade_base_lime",       () -> new BlockArcade(     Blocks.IRON_BLOCK, DyeColor.LIME),       ItemGroup.TAB_DECORATIONS);
    public static final RegistryObject<Block> ARCADE_BASE_PINK       = registerB("arcade_base_pink",       () -> new BlockArcade(     Blocks.IRON_BLOCK, DyeColor.PINK),       ItemGroup.TAB_DECORATIONS);
    public static final RegistryObject<Block> ARCADE_BASE_GRAY       = registerB("arcade_base_gray",       () -> new BlockArcade(     Blocks.IRON_BLOCK, DyeColor.GRAY),       ItemGroup.TAB_DECORATIONS);
    public static final RegistryObject<Block> ARCADE_BASE_LIGHT_GRAY = registerB("arcade_base_light_gray", () -> new BlockArcade(     Blocks.IRON_BLOCK, DyeColor.LIGHT_GRAY), ItemGroup.TAB_DECORATIONS);
    public static final RegistryObject<Block> ARCADE_BASE_CYAN       = registerB("arcade_base_cyan",       () -> new BlockArcade(     Blocks.IRON_BLOCK, DyeColor.CYAN),       ItemGroup.TAB_DECORATIONS);
    public static final RegistryObject<Block> ARCADE_BASE_PURPLE     = registerB("arcade_base_purple",     () -> new BlockArcade(     Blocks.IRON_BLOCK, DyeColor.PURPLE),     ItemGroup.TAB_DECORATIONS);
    public static final RegistryObject<Block> ARCADE_BASE_BLUE       = registerB("arcade_base_blue",       () -> new BlockArcade(     Blocks.IRON_BLOCK, DyeColor.BLUE),       ItemGroup.TAB_DECORATIONS);
    public static final RegistryObject<Block> ARCADE_BASE_BROWN      = registerB("arcade_base_brown",      () -> new BlockArcade(     Blocks.IRON_BLOCK, DyeColor.BROWN),      ItemGroup.TAB_DECORATIONS);
    public static final RegistryObject<Block> ARCADE_BASE_GREEN      = registerB("arcade_base_green",      () -> new BlockArcade(     Blocks.IRON_BLOCK, DyeColor.GREEN),      ItemGroup.TAB_DECORATIONS);
    public static final RegistryObject<Block> ARCADE_BASE_RED        = registerB("arcade_base_red",        () -> new BlockArcade(     Blocks.IRON_BLOCK, DyeColor.RED),        ItemGroup.TAB_DECORATIONS);
    public static final RegistryObject<Block> ARCADE_BASE_BLACK      = registerB("arcade_base_black",      () -> new BlockArcade(     Blocks.IRON_BLOCK, DyeColor.BLACK),      ItemGroup.TAB_DECORATIONS);
    public static final RegistryObject<Block> ARCADE_SLOT_WHITE      = registerB("arcade_slot_white",      () -> new BlockSlotMachine(Blocks.IRON_BLOCK, DyeColor.WHITE),      ItemGroup.TAB_DECORATIONS);
    public static final RegistryObject<Block> ARCADE_SLOT_ORANGE     = registerB("arcade_slot_orange",     () -> new BlockSlotMachine(Blocks.IRON_BLOCK, DyeColor.ORANGE),     ItemGroup.TAB_DECORATIONS);
    public static final RegistryObject<Block> ARCADE_SLOT_MAGENTA    = registerB("arcade_slot_magenta",    () -> new BlockSlotMachine(Blocks.IRON_BLOCK, DyeColor.MAGENTA),    ItemGroup.TAB_DECORATIONS);
    public static final RegistryObject<Block> ARCADE_SLOT_LIGHT_BLUE = registerB("arcade_slot_light_blue", () -> new BlockSlotMachine(Blocks.IRON_BLOCK, DyeColor.LIGHT_BLUE), ItemGroup.TAB_DECORATIONS);
    public static final RegistryObject<Block> ARCADE_SLOT_YELLOW     = registerB("arcade_slot_yellow",     () -> new BlockSlotMachine(Blocks.IRON_BLOCK, DyeColor.YELLOW),     ItemGroup.TAB_DECORATIONS);
    public static final RegistryObject<Block> ARCADE_SLOT_LIME       = registerB("arcade_slot_lime",       () -> new BlockSlotMachine(Blocks.IRON_BLOCK, DyeColor.LIME),       ItemGroup.TAB_DECORATIONS);
    public static final RegistryObject<Block> ARCADE_SLOT_PINK       = registerB("arcade_slot_pink",       () -> new BlockSlotMachine(Blocks.IRON_BLOCK, DyeColor.PINK),       ItemGroup.TAB_DECORATIONS);
    public static final RegistryObject<Block> ARCADE_SLOT_GRAY       = registerB("arcade_slot_gray",       () -> new BlockSlotMachine(Blocks.IRON_BLOCK, DyeColor.GRAY),       ItemGroup.TAB_DECORATIONS);
    public static final RegistryObject<Block> ARCADE_SLOT_LIGHT_GRAY = registerB("arcade_slot_light_gray", () -> new BlockSlotMachine(Blocks.IRON_BLOCK, DyeColor.LIGHT_GRAY), ItemGroup.TAB_DECORATIONS);
    public static final RegistryObject<Block> ARCADE_SLOT_CYAN       = registerB("arcade_slot_cyan",       () -> new BlockSlotMachine(Blocks.IRON_BLOCK, DyeColor.CYAN),       ItemGroup.TAB_DECORATIONS);
    public static final RegistryObject<Block> ARCADE_SLOT_PURPLE     = registerB("arcade_slot_purple",     () -> new BlockSlotMachine(Blocks.IRON_BLOCK, DyeColor.PURPLE),     ItemGroup.TAB_DECORATIONS);
    public static final RegistryObject<Block> ARCADE_SLOT_BLUE       = registerB("arcade_slot_blue",       () -> new BlockSlotMachine(Blocks.IRON_BLOCK, DyeColor.BLUE),       ItemGroup.TAB_DECORATIONS);
    public static final RegistryObject<Block> ARCADE_SLOT_BROWN      = registerB("arcade_slot_brown",      () -> new BlockSlotMachine(Blocks.IRON_BLOCK, DyeColor.BROWN),      ItemGroup.TAB_DECORATIONS);
    public static final RegistryObject<Block> ARCADE_SLOT_GREEN      = registerB("arcade_slot_green",      () -> new BlockSlotMachine(Blocks.IRON_BLOCK, DyeColor.GREEN),      ItemGroup.TAB_DECORATIONS);
    public static final RegistryObject<Block> ARCADE_SLOT_RED        = registerB("arcade_slot_red",        () -> new BlockSlotMachine(Blocks.IRON_BLOCK, DyeColor.RED),        ItemGroup.TAB_DECORATIONS);
    public static final RegistryObject<Block> ARCADE_SLOT_BLACK      = registerB("arcade_slot_black",      () -> new BlockSlotMachine(Blocks.IRON_BLOCK, DyeColor.BLACK),      ItemGroup.TAB_DECORATIONS);

    // ----- Dice Blocks ----- //
    public static final RegistryObject<Block> DICE_BASIC_WHITE      = registerB("dice_basic_white",      () -> new BlockDice(Blocks.TERRACOTTA), ItemGroup.TAB_DECORATIONS);
    public static final RegistryObject<Block> DICE_BASIC_ORANGE     = registerB("dice_basic_orange",     () -> new BlockDice(Blocks.TERRACOTTA), ItemGroup.TAB_DECORATIONS);
    public static final RegistryObject<Block> DICE_BASIC_MAGENTA    = registerB("dice_basic_magenta",    () -> new BlockDice(Blocks.TERRACOTTA), ItemGroup.TAB_DECORATIONS);
    public static final RegistryObject<Block> DICE_BASIC_LIGHT_BLUE = registerB("dice_basic_light_blue", () -> new BlockDice(Blocks.TERRACOTTA), ItemGroup.TAB_DECORATIONS);
    public static final RegistryObject<Block> DICE_BASIC_YELLOW     = registerB("dice_basic_yellow",     () -> new BlockDice(Blocks.TERRACOTTA), ItemGroup.TAB_DECORATIONS);
    public static final RegistryObject<Block> DICE_BASIC_LIME       = registerB("dice_basic_lime",       () -> new BlockDice(Blocks.TERRACOTTA), ItemGroup.TAB_DECORATIONS);
    public static final RegistryObject<Block> DICE_BASIC_PINK       = registerB("dice_basic_pink",       () -> new BlockDice(Blocks.TERRACOTTA), ItemGroup.TAB_DECORATIONS);
    public static final RegistryObject<Block> DICE_BASIC_GRAY       = registerB("dice_basic_gray",       () -> new BlockDice(Blocks.TERRACOTTA), ItemGroup.TAB_DECORATIONS);
    public static final RegistryObject<Block> DICE_BASIC_LIGHT_GRAY = registerB("dice_basic_light_gray", () -> new BlockDice(Blocks.TERRACOTTA), ItemGroup.TAB_DECORATIONS);
    public static final RegistryObject<Block> DICE_BASIC_CYAN       = registerB("dice_basic_cyan",       () -> new BlockDice(Blocks.TERRACOTTA), ItemGroup.TAB_DECORATIONS);
    public static final RegistryObject<Block> DICE_BASIC_PURPLE     = registerB("dice_basic_purple",     () -> new BlockDice(Blocks.TERRACOTTA), ItemGroup.TAB_DECORATIONS);
    public static final RegistryObject<Block> DICE_BASIC_BLUE       = registerB("dice_basic_blue",       () -> new BlockDice(Blocks.TERRACOTTA), ItemGroup.TAB_DECORATIONS);
    public static final RegistryObject<Block> DICE_BASIC_BROWN      = registerB("dice_basic_brown",      () -> new BlockDice(Blocks.TERRACOTTA), ItemGroup.TAB_DECORATIONS);
    public static final RegistryObject<Block> DICE_BASIC_GREEN      = registerB("dice_basic_green",      () -> new BlockDice(Blocks.TERRACOTTA), ItemGroup.TAB_DECORATIONS);
    public static final RegistryObject<Block> DICE_BASIC_RED        = registerB("dice_basic_red",        () -> new BlockDice(Blocks.TERRACOTTA), ItemGroup.TAB_DECORATIONS);
    public static final RegistryObject<Block> DICE_BASIC_BLACK      = registerB("dice_basic_black",      () -> new BlockDice(Blocks.TERRACOTTA), ItemGroup.TAB_DECORATIONS);

    // ----- Modules ----- //
    public static final RegistryObject<Item> MODULE_MINO_WHITE      = registerI("module_mino_white",      () -> new ItemItem(ItemGroup.TAB_MISC));
    public static final RegistryObject<Item> MODULE_MINO_ORANGE     = registerI("module_mino_orange",     () -> new ItemItem(ItemGroup.TAB_MISC));
    public static final RegistryObject<Item> MODULE_MINO_MAGENTA    = registerI("module_mino_magenta",    () -> new ItemItem(ItemGroup.TAB_MISC));
    public static final RegistryObject<Item> MODULE_MINO_LIGHT_BLUE = registerI("module_mino_light_blue", () -> new ItemItem(ItemGroup.TAB_MISC));
    public static final RegistryObject<Item> MODULE_MINO_YELLOW     = registerI("module_mino_yellow",     () -> new ItemItem(ItemGroup.TAB_MISC));
    public static final RegistryObject<Item> MODULE_MINO_LIME       = registerI("module_mino_lime",       () -> new ItemItem(ItemGroup.TAB_MISC));
    public static final RegistryObject<Item> MODULE_MINO_PINK       = registerI("module_mino_pink",       () -> new ItemItem(ItemGroup.TAB_MISC));
    public static final RegistryObject<Item> MODULE_MINO_GRAY       = registerI("module_mino_gray",       () -> new ItemItem(ItemGroup.TAB_MISC));
    public static final RegistryObject<Item> MODULE_MINO_LIGHT_GRAY = registerI("module_mino_light_gray", () -> new ItemItem(ItemGroup.TAB_MISC));
    public static final RegistryObject<Item> MODULE_MINO_CYAN       = registerI("module_mino_cyan",       () -> new ItemItem(ItemGroup.TAB_MISC));
    public static final RegistryObject<Item> MODULE_MINO_PURPLE     = registerI("module_mino_purple",     () -> new ItemItem(ItemGroup.TAB_MISC));
    public static final RegistryObject<Item> MODULE_MINO_BLUE       = registerI("module_mino_blue",       () -> new ItemItem(ItemGroup.TAB_MISC));
    public static final RegistryObject<Item> MODULE_MINO_BROWN      = registerI("module_mino_brown",      () -> new ItemItem(ItemGroup.TAB_MISC));
    public static final RegistryObject<Item> MODULE_MINO_GREEN      = registerI("module_mino_green",      () -> new ItemItem(ItemGroup.TAB_MISC));
    public static final RegistryObject<Item> MODULE_MINO_RED        = registerI("module_mino_red",        () -> new ItemItem(ItemGroup.TAB_MISC));
    public static final RegistryObject<Item> MODULE_MINO_BLACK      = registerI("module_mino_black",      () -> new ItemItem(ItemGroup.TAB_MISC));
    public static final RegistryObject<Item> MODULE_CHIP_WHITE      = registerI("module_chip_white",      () -> new ItemItem(ItemGroup.TAB_MISC));
    public static final RegistryObject<Item> MODULE_CHIP_ORANGE     = registerI("module_chip_orange",     () -> new ItemItem(ItemGroup.TAB_MISC));
    public static final RegistryObject<Item> MODULE_CHIP_MAGENTA    = registerI("module_chip_magenta",    () -> new ItemItem(ItemGroup.TAB_MISC));
    public static final RegistryObject<Item> MODULE_CHIP_LIGHT_BLUE = registerI("module_chip_light_blue", () -> new ItemItem(ItemGroup.TAB_MISC));
    public static final RegistryObject<Item> MODULE_CHIP_YELLOW     = registerI("module_chip_yellow",     () -> new ItemItem(ItemGroup.TAB_MISC));
    public static final RegistryObject<Item> MODULE_CHIP_LIME       = registerI("module_chip_lime",       () -> new ItemItem(ItemGroup.TAB_MISC));
    public static final RegistryObject<Item> MODULE_CHIP_PINK       = registerI("module_chip_pink",       () -> new ItemItem(ItemGroup.TAB_MISC));
    public static final RegistryObject<Item> MODULE_CHIP_GRAY       = registerI("module_chip_gray",       () -> new ItemItem(ItemGroup.TAB_MISC));
    public static final RegistryObject<Item> MODULE_CHIP_LIGHT_GRAY = registerI("module_chip_light_gray", () -> new ItemItem(ItemGroup.TAB_MISC));
    public static final RegistryObject<Item> MODULE_CHIP_CYAN       = registerI("module_chip_cyan",       () -> new ItemItem(ItemGroup.TAB_MISC));
    public static final RegistryObject<Item> MODULE_CHIP_PURPLE     = registerI("module_chip_purple",     () -> new ItemItem(ItemGroup.TAB_MISC));
    public static final RegistryObject<Item> MODULE_CHIP_BLUE       = registerI("module_chip_blue",       () -> new ItemItem(ItemGroup.TAB_MISC));
    public static final RegistryObject<Item> MODULE_CHIP_BROWN      = registerI("module_chip_brown",      () -> new ItemItem(ItemGroup.TAB_MISC));
    public static final RegistryObject<Item> MODULE_CHIP_GREEN      = registerI("module_chip_green",      () -> new ItemItem(ItemGroup.TAB_MISC));
    public static final RegistryObject<Item> MODULE_CHIP_RED        = registerI("module_chip_red",        () -> new ItemItem(ItemGroup.TAB_MISC));
    public static final RegistryObject<Item> MODULE_CHIP_BLACK      = registerI("module_chip_black",      () -> new ItemItem(ItemGroup.TAB_MISC));
    public static final RegistryObject<Item> MODULE_CARD_WHITE      = registerI("module_card_white",      () -> new ItemItem(ItemGroup.TAB_MISC));
    public static final RegistryObject<Item> MODULE_CARD_ORANGE     = registerI("module_card_orange",     () -> new ItemItem(ItemGroup.TAB_MISC));
    public static final RegistryObject<Item> MODULE_CARD_MAGENTA    = registerI("module_card_magenta",    () -> new ItemItem(ItemGroup.TAB_MISC));
    public static final RegistryObject<Item> MODULE_CARD_LIGHT_BLUE = registerI("module_card_light_blue", () -> new ItemItem(ItemGroup.TAB_MISC));
    public static final RegistryObject<Item> MODULE_CARD_YELLOW     = registerI("module_card_yellow",     () -> new ItemItem(ItemGroup.TAB_MISC));
    public static final RegistryObject<Item> MODULE_CARD_LIME       = registerI("module_card_lime",       () -> new ItemItem(ItemGroup.TAB_MISC));
    public static final RegistryObject<Item> MODULE_CARD_PINK       = registerI("module_card_pink",       () -> new ItemItem(ItemGroup.TAB_MISC));
    public static final RegistryObject<Item> MODULE_CARD_GRAY       = registerI("module_card_gray",       () -> new ItemItem(ItemGroup.TAB_MISC));
    public static final RegistryObject<Item> MODULE_CARD_LIGHT_GRAY = registerI("module_card_light_gray", () -> new ItemItem(ItemGroup.TAB_MISC));
    public static final RegistryObject<Item> MODULE_CARD_CYAN       = registerI("module_card_cyan",       () -> new ItemItem(ItemGroup.TAB_MISC));
    public static final RegistryObject<Item> MODULE_CARD_PURPLE     = registerI("module_card_purple",     () -> new ItemItem(ItemGroup.TAB_MISC));
    public static final RegistryObject<Item> MODULE_CARD_BLUE       = registerI("module_card_blue",       () -> new ItemItem(ItemGroup.TAB_MISC));
    public static final RegistryObject<Item> MODULE_CARD_BROWN      = registerI("module_card_brown",      () -> new ItemItem(ItemGroup.TAB_MISC));
    public static final RegistryObject<Item> MODULE_CARD_GREEN      = registerI("module_card_green",      () -> new ItemItem(ItemGroup.TAB_MISC));
    public static final RegistryObject<Item> MODULE_CARD_RED        = registerI("module_card_red",        () -> new ItemItem(ItemGroup.TAB_MISC));
    public static final RegistryObject<Item> MODULE_CARD_BLACK      = registerI("module_card_black",      () -> new ItemItem(ItemGroup.TAB_MISC));
    ...
    private static RegistryObject<Block> registerB(String name,  java.util.function.Supplier<? extends Block> block, ItemGroup itemGroup){
        RegistryObject<Block> rob = BLOCKS.register(name, block);
        if(itemGroup != null){ ITEMS.register(name, () -> new BlockItem(rob.get(), (new Item.Properties()).tab(itemGroup))); }
        return rob;
    }
    ...
    // Conveniance function: Take a RegistryObject<Block> and make a corresponding RegistryObject<Item> from it
    public static <B extends Block> RegistryObject<Item> fromBlock(RegistryObject<B> block, ItemGroup itemGroup) {
        return ITEMS.register(block.getId().getPath(), () -> new BlockItem(block.get(), (new Item.Properties()).tab(itemGroup) ));
    }
