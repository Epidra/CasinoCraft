...
import mod.casinocraft.client.logic.game.Logic51;
...
public class Screen51 extends ScreenCasino {   //  Tetris
	...
	private void drawTrimino(GuiGraphics matrix, int mino0, int mino1, int mino2, int x, int y) {
	...
	private void drawDomino(GuiGraphics matrix, int mino0, int mino1, int x, int y) {
