...
private final IInventory tileSlotMachine;
    ...
    public void addListener(IContainerListener listener){
        ...
        listener.sendAllWindowProperties(this, this.tileSlotMachine);
    }
    ...
    public void updateProgressBar(int id, int data){
        this.tileSlotMachine.setField(id, data);
    }
    
    public boolean canInteractWith(EntityPlayer playerIn){
        return this.tileSlotMachine.isUsableByPlayer(playerIn);
    }
