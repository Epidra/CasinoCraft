...
//                CasinoPacketHandler.sendToServer(new ServerBoardMessage(tileCardTable.bet_low, tileCardTable.bet_high, tileCardTable.transfer_in, tileCardTable.transfer_out, tileCardTable.isCreative, tileCardTable.getPos()));
//            }
...
//                    CasinoPacketHandler.sendToServer(new ServerBlockMessage(tileCardTable.inventory.get(0), tileCardTable.inventory.get(1), tileCardTable.inventory.get(4), tileCardTable.bet_storage, tileCardTable.getPos()));
//                }
//            }
