...
public class GuiCardTable extends ContainerScreen<ContainerMachine> {
    ...
    public GuiCardTable(ContainerMachine container, PlayerInventory player, ITextComponent name) {
