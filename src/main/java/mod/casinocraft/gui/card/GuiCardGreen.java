...
public class GuiCardGreen extends GuiCasino {   // -----
    ...
    public GuiCardGreen(InventoryPlayer playerInv, IInventory furnaceInv, BlockPos pos, World world){
        super(new ContainerCardGreen(playerInv, furnaceInv, pos, world), playerInv);
    }
