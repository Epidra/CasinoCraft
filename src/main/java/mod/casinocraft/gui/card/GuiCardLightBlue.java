...
public class GuiCardLightBlue extends GuiCasino {   // Klondike
    ...
    public GuiCardLightBlue(InventoryPlayer playerInv, IInventory furnaceInv, BlockPos pos, World world){
        super(new ContainerCardLightBlue(playerInv, furnaceInv, pos, world), playerInv);
    }
