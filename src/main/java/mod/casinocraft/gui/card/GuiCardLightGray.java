...
public class GuiCardLightGray extends GuiCasino {   // Draw Poker
    ...
    public GuiCardLightGray(InventoryPlayer playerInv, IInventory furnaceInv, BlockPos pos, World world){
        super(new ContainerCardLightGray(playerInv, furnaceInv, pos, world), playerInv);
    }
