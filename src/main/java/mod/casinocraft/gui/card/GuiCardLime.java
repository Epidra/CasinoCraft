...
public class GuiCardLime extends GuiCasino {   // -----
    ...
    public GuiCardLime(InventoryPlayer playerInv, IInventory furnaceInv, BlockPos pos, World world){
        super(new ContainerCardLime(playerInv, furnaceInv, pos, world), playerInv);
    }
