...
public class GuiCardMagenta extends GuiCasino {   // Pyramid
    ...
    public GuiCardMagenta(InventoryPlayer playerInv, IInventory furnaceInv, BlockPos pos, World world){
        super(new ContainerCardMagenta(playerInv, furnaceInv, pos, world), playerInv);
    }
