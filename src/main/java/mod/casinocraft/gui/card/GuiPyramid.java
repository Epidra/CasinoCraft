...
import mod.casinocraft.logic.card.LogicPyramid;
...
public class GuiPyramid extends GuiCasino {
    ...
    public GuiPyramid(ContainerCasino container, PlayerInventory player, ITextComponent name) {
    ...
    public LogicPyramid logic(){
        return (LogicPyramid) CONTAINER.logic();
    }
