...
public class GuiChipBrown extends GuiCasino {   // -----
    ...
    public GuiChipBrown(InventoryPlayer playerInv, IInventory furnaceInv, BlockPos pos, World world) {
        super(new ContainerChipBrown(playerInv, furnaceInv, pos, world), playerInv);
    }
