...
public class GuiChipLime extends GuiCasino {   // -----
    ...
    public GuiChipLime(InventoryPlayer playerInv, IInventory furnaceInv, BlockPos pos, World world) {
        super(new ContainerChipLime(playerInv, furnaceInv, pos, world), playerInv);
    }
