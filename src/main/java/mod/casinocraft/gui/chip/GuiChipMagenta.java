...
public class GuiChipMagenta extends GuiCasino {   // -----
    ...
    public GuiChipMagenta(InventoryPlayer playerInv, IInventory furnaceInv, BlockPos pos, World world) {
        super(new ContainerChipMagenta(playerInv, furnaceInv, pos, world), playerInv);
    }
