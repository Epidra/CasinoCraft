...
public class GuiChipYellow extends GuiCasino {   // -----
    ...
    public GuiChipYellow(InventoryPlayer playerInv, IInventory furnaceInv, BlockPos pos, World world) {
        super(new ContainerChipYellow(playerInv, furnaceInv, pos, world), playerInv);
    }
