    ...
    protected void drawGuiContainerBackgroundLayer2(float partialTicks, int mouseX, int mouseY){
        ...
        for(int y = 0; y < 14; y++){
            for(int x = 0; x < 26; x++){
                ...
                if(i >= 20){
                    this.blit(guiLeft-96 + 16 + 16*x, guiTop + 16 + 16*y, 112, 216-24, 16, 16);
                } else {
                    if(i == 9) {
                        this.blit(guiLeft-96 + 16 + 16*x, guiTop + 16 + 16*y, 192, 216-24, 16, 16);
                    } else if(i == 10) {
                        this.blit(guiLeft-96 + 16 + 16*x, guiTop + 16 + 16*y, 208, 216-24, 16, 16);
                    } else if(i > 0){
