...
public class GuiMinoBrown extends GuiCasino {   // -----
    ...
    public GuiMinoBrown(InventoryPlayer playerInv, IInventory furnaceInv, BlockPos pos, World world) {
        super(new ContainerMinoBrown(playerInv, furnaceInv, pos, world), playerInv);
    }
