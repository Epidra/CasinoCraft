...
public class GuiMinoOrange extends GuiCasino {   // Craps
    ...
    public GuiMinoOrange(InventoryPlayer playerInv, IInventory furnaceInv, BlockPos pos, World world) {
        super(new ContainerMinoOrange(playerInv, furnaceInv, pos, world), playerInv);
