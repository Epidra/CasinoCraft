...
public class LogicCardBlack extends LogicBase {   // Black Jack
    ...
    public void load2(NBTTagCompound compound){
        ...
        value_player1 = compound.getInteger("valueplayer1");
        value_player2 = compound.getInteger("valueplayer2");
        value_dealer = compound.getInteger("valuedealer");
        split = compound.getInteger("split");
    }
    ...
    public NBTTagCompound save2(NBTTagCompound compound){
        ...
        compound.setInteger("valueplayer1", value_player1);
        compound.setInteger("valueplayer2", value_player2);
        compound.setInteger("valuedealer", value_dealer);
        compound.setInteger("split", split);
        return compound;
    }
