...
public class LogicMinoOrange extends LogicBase {   // Craps
    ...
    public void load2(NBTTagCompound compound){
        ...
        result = compound.getInteger("result");
        point = compound.getInteger("point");
        comepoint = compound.getInteger("comepoint");
    }

    public NBTTagCompound save2(NBTTagCompound compound){
        saveDice(compound, dice);
        compound.setInteger("result", result);
        compound.setInteger("point", point);
        compound.setInteger("comepoint", comepoint);
        return compound;
    }
