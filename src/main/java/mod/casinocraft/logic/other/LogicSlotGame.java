...
public class LogicSlotGame extends LogicBase {
    ...
    public void load2(NBTTagCompound compound){
        ...
        wheel = compound.getInteger("wheel");
        wheelPos[0] = compound.getInteger("wheelpos0");
        wheelPos[1] = compound.getInteger("wheelpos1");
        wheelPos[2] = compound.getInteger("wheelpos2");
    ...
    public NBTTagCompound save2(NBTTagCompound compound){
        ...
        compound.setInteger("wheel", wheel);
        compound.setInteger("wheelpos0", wheelPos[0]);
        compound.setInteger("wheelpos1", wheelPos[1]);
        compound.setInteger("wheelpos2", wheelPos[2]);
        compound.setBoolean("lines0", lines[0]);
        compound.setBoolean("lines1", lines[1]);
        compound.setBoolean("lines2", lines[2]);
        compound.setBoolean("lines3", lines[3]);
        compound.setBoolean("lines4", lines[4]);
        return compound;
    }
