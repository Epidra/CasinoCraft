...
public class MessageBlockClient {
    ...
    public MessageBlockClient(ItemStack stack0, ItemStack stack1, ItemStack stack4, int storage, BlockPos pos) {
    ...
    public static void encode (MessageBlockClient msg, PacketBuffer buf) {
    ...
    public static MessageBlockClient decode (PacketBuffer buf) {
        ...
        int _y = buf.readInt();
        int _z = buf.readInt();
        return new MessageBlockClient(_stack0, _stack1, _stack4, _amount, new BlockPos(_x, _y, _z));
    }

    public static class Handler {
        public static void handle (final MessageBlockClient message, Supplier<NetworkEvent.Context> context) {
