...
public class MessageBlockClient implements IMessage {
    ...
    public static class Handler implements IMessageHandler<MessageBlockClient, IMessage> {
        ...
        @Override
        public IMessage onMessage (final MessageBlockClient message, final MessageContext context) {
