...
public class ServerBlockMessage implements IMessage {
    ...
    public static class Handler implements IMessageHandler<ServerBlockMessage, IMessage> {
    	...
    	@Override
        public IMessage onMessage (final ServerBlockMessage message, final MessageContext context) {
    		...
    		CasinoPacketHandler.INSTANCE.sendToAll(new ClientBlockMessage(
    				message.stack0,  
    				message.stack1, 
    				message.stack4, 
    				amount, 
