...
public class ServerInventoryMessage {
    ...
    public ServerInventoryMessage(NonNullList<ItemStack> inventory, BlockPos pos) {
    ...
    public static void encode (ServerInventoryMessage msg, PacketBuffer buf) {
    ...
    public static ServerInventoryMessage decode (PacketBuffer buf) {
        ...
        inv.set(4, _stack4);
        inv.set(5, _stack5);
        return new ServerInventoryMessage(inv, new BlockPos(_x, _y, _z));
    }

    public static class Handler {
        public static void handle (final ServerInventoryMessage message, Supplier<NetworkEvent.Context> context) {
            ...
            CasinoPacketHandler.sendToAll(new PacketClientInventoryMessage(inv, new BlockPos(message.x, message.y, message.z)));
