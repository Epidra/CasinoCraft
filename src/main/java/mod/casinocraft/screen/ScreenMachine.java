...
public class ScreenMachine extends ScreenBase<MenuMachine> {
    ...
    private void createButtons(){
        ...
        // SETTING
        buttonSet.addButton(6, pos_button_left_1, new Vector2(176, 112), new Vector2(192, 128), new Vector2(192, 0), new Vector2(16, 16), -1, () -> this.page == 0 && this.hasKey() && (Config.CASINO.config_creative_token.get() && isOP()), () -> this.commandToggleSettings(0)); // ???
        buttonSet.addButton(7, pos_button_left_2, new Vector2(176, 112), new Vector2(192, 128), new Vector2(192, 0), new Vector2(16, 16), -1, () -> this.page == 0 && this.hasKey() && (Config.CASINO.config_creative_reward.get() && isOP()), () -> this.commandToggleSettings(1)); // ???
    ...
    protected void renderLabels(PoseStack matrix, int mouseX, int mouseY){
        ...
        if(page == 3){
            ...
            this.itemRenderer.renderGuiItem(menu.getItemToken(),  3+64+4+4 -2, 4+2+3+2+4 +2       );
        ...
        if(page == 4){
            ...
            this.itemRenderer.renderGuiItem(menu.getItemPrize(),  3+64+4+4 -2, 4+2+3+2+4 +2       );
            drawFontInvert(matrix, text, 3+64+4+4+78-4 -4+2, 4+2+3+2 +4  +4+2+4 );
    ...
    protected void renderBg(PoseStack matrix, float partialTicks, int mouseX, int mouseY){
        ...
        // ----- Background ----- //
        blit(matrix, posX,       posY,        0,   0, 176, 86); // Background 1
        blit(matrix, posX,       posY+86+2+2,        0,   86+2, 176, 90); // Background 2
        blit(matrix, posX -  56, posY - 0,        0, 228,  54,  28); // Slot 1
        blit(matrix, posX -  56, posY + 29,  54, this.hasKey() ? 228 : 200,  54,  28); // Slot 2
        blit(matrix, posX -  56, posY + 58 + 0,  this.hasModule() ? 0 : 54, 200,  54,  28); // Slot 3
        
        blit(matrix, posX + 176 + 2+1,       posY, 0,   0, 27-1, 86+1); // Background - Pages
        blit(matrix, posX + 176 + 2+1 + 27-1,  posY, 149-1, 0, 27-1, 86+1); // Background - Pages
        
        blit(matrix, posX + 176 + 1 + 2 + 3, posY - 2 + 2 + 3, 160,   176, 48, 16); // Page Button 1
        blit(matrix, posX + 176 + 1 + 2 + 3, posY - 1 + 1 + 3 + 16, 160,   192, 48, 16); // Page Button 2
        blit(matrix, posX + 176 + 1 + 2 + 3, posY + 0 + 3 + 16 + 16, 160,   208, 48, 16); // Page Button 3
        blit(matrix, posX + 176 + 1 + 2 + 3, posY + 1 - 1 + 3 + 16 + 16 + 16, 160,   224, 48, 16); // Page Button 4
        blit(matrix, posX + 176 + 1 + 2 + 3, posY + 2 - 2 + 3 + 16 + 16 + 16 + 16, 160,   240, 48, 16); // Page Button 5
        
        if(this.hasKey()){
            if(page == 0){
                blit(matrix, posX + pos_button_left_1.X, posY + pos_button_left_1.Y - 6, 176, 0, 16, 16);
                blit(matrix, posX + pos_button_left_2.X, posY + pos_button_left_2.Y - 6, 176, 0, 16, 16);
                blit(matrix, posX + pos_button_left_3.X, posY + pos_button_left_3.Y - 6, 176, 0, 16, 16);
                blit(matrix, posX + pos_button_left_4.X, posY + pos_button_left_4.Y - 6, 176, 0, 16, 16);
                blit(matrix, posX + pos_button_left_5.X, posY + pos_button_left_5.Y - 6, 176, 0, 16, 16);
            }
            if(page == 1){
                blit(matrix, posX + pos_button_left_1.X, posY + pos_button_left_1.Y - 6, 176, 0, 16, 16);
                blit(matrix, posX + pos_button_left_2.X, posY + pos_button_left_2.Y - 6, 176, 0, 16, 16);
                ...
                blit(matrix, posX + pos_button_right_1.X, posY + pos_button_right_1.Y - 6, 176, 0, 16, 16);
                blit(matrix, posX + pos_button_right_2.X, posY + pos_button_right_2.Y - 6, 176, 0, 16, 16);
                blit(matrix, posX + pos_button_right_3.X, posY + pos_button_right_3.Y - 6, 176, 0, 16, 16);
                blit(matrix, posX + pos_button_right_4.X, posY + pos_button_right_4.Y - 6, 176, 0, 16, 16);
                blit(matrix, posX + pos_button_right_5.X, posY + pos_button_right_5.Y - 6, 176, 0, 16, 16);
                
                blit(matrix, posX + pos_button_left_1.X + 19 + 6     , posY + pos_button_left_1.Y - 6 + 2, 110, 229, 40, 12);
                blit(matrix, posX + pos_button_left_1.X + 19 + 6 + 40, posY + pos_button_left_1.Y - 6 + 2, 111, 229, 40, 12);
                blit(matrix, posX + pos_button_left_1.X + 19 + 6 + 80, posY + pos_button_left_1.Y - 6 + 2, 112, 229, 40, 12);
                
                blit(matrix, posX + pos_button_left_2.X + 19 + 6     , posY + pos_button_left_2.Y - 6 + 2, 110, this.hasRules(1) ? 243 : 215, 40, 12);
                blit(matrix, posX + pos_button_left_2.X + 19 + 6 + 40, posY + pos_button_left_2.Y - 6 + 2, 111, this.hasRules(1) ? 243 : 215, 40, 12);
                blit(matrix, posX + pos_button_left_2.X + 19 + 6 + 80, posY + pos_button_left_2.Y - 6 + 2, 112, this.hasRules(1) ? 243 : 215, 40, 12);
                
                blit(matrix, posX + pos_button_left_3.X + 19 + 6     , posY + pos_button_left_3.Y - 6 + 2, 110, this.hasRules(2) ? 243 : 215, 40, 12);
                blit(matrix, posX + pos_button_left_3.X + 19 + 6 + 40, posY + pos_button_left_3.Y - 6 + 2, 111, this.hasRules(2) ? 243 : 215, 40, 12);
                blit(matrix, posX + pos_button_left_3.X + 19 + 6 + 80, posY + pos_button_left_3.Y - 6 + 2, 112, this.hasRules(2) ? 243 : 215, 40, 12);
                
                blit(matrix, posX + pos_button_left_4.X + 19 + 6     , posY + pos_button_left_4.Y - 6 + 2, 110, this.hasRules(3) ? 243 : 215, 40, 12);
                blit(matrix, posX + pos_button_left_4.X + 19 + 6 + 40, posY + pos_button_left_4.Y - 6 + 2, 111, this.hasRules(3) ? 243 : 215, 40, 12);
                blit(matrix, posX + pos_button_left_4.X + 19 + 6 + 80, posY + pos_button_left_4.Y - 6 + 2, 112, this.hasRules(3) ? 243 : 215, 40, 12);
                
                blit(matrix, posX + pos_button_left_5.X + 19 + 6     , posY + pos_button_left_5.Y - 6 + 2, 110, this.hasRules(4) ? 243 : 215, 40, 12);
                blit(matrix, posX + pos_button_left_5.X + 19 + 6 + 40, posY + pos_button_left_5.Y - 6 + 2, 111, this.hasRules(4) ? 243 : 215, 40, 12);
                blit(matrix, posX + pos_button_left_5.X + 19 + 6 + 80, posY + pos_button_left_5.Y - 6 + 2, 112, this.hasRules(4) ? 243 : 215, 40, 12);
            }
            if(page == 2){
                
                if(menu.tableID < 3 && getColoringType() == 0){ // Cards
                    if(menu.getSettingAlternateColor() == 0){
                        RenderSystem.setShaderTexture(0, CasinoKeeper.TEXTURE_CARDS_0_ROUGE); blit(matrix, leftPos+8 + 112, topPos + 16, 4 * 32, 1 * 48, 32, 48);
                        RenderSystem.setShaderTexture(0, CasinoKeeper.TEXTURE_CARDS_0_NOIR ); blit(matrix, leftPos+8 + 88, topPos + 16, 4 * 32, 1 * 48, 32, 48);
                        RenderSystem.setShaderTexture(0, CasinoKeeper.TEXTURE_CARDS_0_ROUGE); blit(matrix, leftPos+8 + 64, topPos + 16, 4 * 32, 3 * 48, 32, 48);
                        RenderSystem.setShaderTexture(0, CasinoKeeper.TEXTURE_CARDS_0_NOIR ); blit(matrix, leftPos+8 + 40, topPos + 16, 4 * 32, 3 * 48, 32, 48);
                        RenderSystem.setShaderTexture(0, CasinoKeeper.TEXTURE_CARDS_0_NOIR ); blit(matrix, leftPos +8+ 16, topPos + 16, 0 * 32, 4 * 48, 32, 48);
                    }
                    if(menu.getSettingAlternateColor() == 1){
                        RenderSystem.setShaderTexture(0, CasinoKeeper.TEXTURE_CARDS_1_ROUGE); blit(matrix, leftPos+8 + 112, topPos + 16, 4 * 32, 1 * 48, 32, 48);
                        RenderSystem.setShaderTexture(0, CasinoKeeper.TEXTURE_CARDS_1_NOIR ); blit(matrix, leftPos+8 + 88, topPos + 16, 4 * 32, 1 * 48, 32, 48);
                        RenderSystem.setShaderTexture(0, CasinoKeeper.TEXTURE_CARDS_1_ROUGE); blit(matrix, leftPos+8 + 64, topPos + 16, 4 * 32, 3 * 48, 32, 48);
                        RenderSystem.setShaderTexture(0, CasinoKeeper.TEXTURE_CARDS_1_NOIR ); blit(matrix, leftPos+8 + 40, topPos + 16, 4 * 32, 3 * 48, 32, 48);
                        RenderSystem.setShaderTexture(0, CasinoKeeper.TEXTURE_CARDS_1_NOIR ); blit(matrix, leftPos +8+ 16, topPos + 16, 0 * 32, 4 * 48, 32, 48);
                    }
                    if(menu.getSettingAlternateColor() == 2){
                        RenderSystem.setShaderTexture(0, CasinoKeeper.TEXTURE_CARDS_2_ROUGE); blit(matrix, leftPos+8 + 112, topPos + 16, 4 * 32, 1 * 48, 32, 48);
                        RenderSystem.setShaderTexture(0, CasinoKeeper.TEXTURE_CARDS_2_NOIR ); blit(matrix, leftPos+8 + 88, topPos + 16, 4 * 32, 1 * 48, 32, 48);
                        RenderSystem.setShaderTexture(0, CasinoKeeper.TEXTURE_CARDS_2_ROUGE); blit(matrix, leftPos+8 + 64, topPos + 16, 4 * 32, 3 * 48, 32, 48);
                        RenderSystem.setShaderTexture(0, CasinoKeeper.TEXTURE_CARDS_2_NOIR ); blit(matrix, leftPos+8 + 40, topPos + 16, 4 * 32, 3 * 48, 32, 48);
                        RenderSystem.setShaderTexture(0, CasinoKeeper.TEXTURE_CARDS_2_NOIR ); blit(matrix, leftPos +8+ 16, topPos + 16, 0 * 32, 4 * 48, 32, 48);
                    }
                    if(menu.getSettingAlternateColor() == 3){
                        RenderSystem.setShaderTexture(0, CasinoKeeper.TEXTURE_CARDS_3_ROUGE); blit(matrix, leftPos+8 + 112, topPos + 16, 4 * 32, 1 * 48, 32, 48);
                        RenderSystem.setShaderTexture(0, CasinoKeeper.TEXTURE_CARDS_3_NOIR ); blit(matrix, leftPos+8 + 88, topPos + 16, 4 * 32, 1 * 48, 32, 48);
                        RenderSystem.setShaderTexture(0, CasinoKeeper.TEXTURE_CARDS_3_ROUGE); blit(matrix, leftPos+8 + 64, topPos + 16, 4 * 32, 3 * 48, 32, 48);
                        RenderSystem.setShaderTexture(0, CasinoKeeper.TEXTURE_CARDS_3_NOIR ); blit(matrix, leftPos+8 + 40, topPos + 16, 4 * 32, 3 * 48, 32, 48);
                        RenderSystem.setShaderTexture(0, CasinoKeeper.TEXTURE_CARDS_3_NOIR ); blit(matrix, leftPos +8+ 16, topPos + 16, 0 * 32, 4 * 48, 32, 48);
                    }
                    if(menu.getSettingAlternateColor() == 4){
                        RenderSystem.setShaderTexture(0, CasinoKeeper.TEXTURE_CARDS_4_ROUGE); blit(matrix, leftPos+8 + 112, topPos + 16, 4 * 32, 1 * 48, 32, 48);
                        RenderSystem.setShaderTexture(0, CasinoKeeper.TEXTURE_CARDS_4_NOIR ); blit(matrix, leftPos+8 + 88, topPos + 16, 4 * 32, 1 * 48, 32, 48);
                        RenderSystem.setShaderTexture(0, CasinoKeeper.TEXTURE_CARDS_4_ROUGE); blit(matrix, leftPos+8 + 64, topPos + 16, 4 * 32, 3 * 48, 32, 48);
                        RenderSystem.setShaderTexture(0, CasinoKeeper.TEXTURE_CARDS_4_NOIR ); blit(matrix, leftPos+8 + 40, topPos + 16, 4 * 32, 3 * 48, 32, 48);
                        RenderSystem.setShaderTexture(0, CasinoKeeper.TEXTURE_CARDS_4_NOIR ); blit(matrix, leftPos +8+ 16, topPos + 16, 0 * 32, 4 * 48, 32, 48);
                    }
                    if(menu.getSettingAlternateColor() == 5){
                        RenderSystem.setShaderTexture(0, CasinoKeeper.TEXTURE_CARDS_5_ROUGE); blit(matrix, leftPos+8 + 112, topPos + 16, 4 * 32, 1 * 48, 32, 48);
                        RenderSystem.setShaderTexture(0, CasinoKeeper.TEXTURE_CARDS_5_NOIR ); blit(matrix, leftPos+8 + 88, topPos + 16, 4 * 32, 1 * 48, 32, 48);
                        RenderSystem.setShaderTexture(0, CasinoKeeper.TEXTURE_CARDS_5_ROUGE); blit(matrix, leftPos+8 + 64, topPos + 16, 4 * 32, 3 * 48, 32, 48);
                        RenderSystem.setShaderTexture(0, CasinoKeeper.TEXTURE_CARDS_5_NOIR ); blit(matrix, leftPos+8 + 40, topPos + 16, 4 * 32, 3 * 48, 32, 48);
                        RenderSystem.setShaderTexture(0, CasinoKeeper.TEXTURE_CARDS_5_NOIR ); blit(matrix, leftPos +8+ 16, topPos + 16, 0 * 32, 4 * 48, 32, 48);
                    }
                }
                if(menu.tableID < 3 && getColoringType() == 1){ // Dice
                    RenderSystem.setShaderTexture(0, CasinoKeeper.TEXTURE_DICE);
                    blit(matrix, leftPos + 176/2 - 16 - 32 - 2, topPos + 8+2, 0 * 32, (menu.getSettingAlternateColor() + 1) * 32, 32, 32);
                    blit(matrix, leftPos + 176/2 - 16, topPos + 8+2, 1 * 32, (menu.getSettingAlternateColor() + 1) * 32, 32, 32);
                    blit(matrix, leftPos + 176/2 - 16 + 32 + 2, topPos + 8+2, 2 * 32, (menu.getSettingAlternateColor() + 1) * 32, 32, 32);
                    blit(matrix, leftPos + 176/2 - 16 - 32 - 2, topPos + 48-4-2, 3 * 32, (menu.getSettingAlternateColor() + 1) * 32, 32, 32);
                    blit(matrix, leftPos + 176/2 - 16, topPos + 48-4-2, 4 * 32, (menu.getSettingAlternateColor() + 1) * 32, 32, 32);
                    blit(matrix, leftPos + 176/2 - 16 + 32 + 2, topPos + 48-4-2, 5 * 32, (menu.getSettingAlternateColor() + 1) * 32, 32, 32);
                }
                if(menu.tableID < 3 && getColoringType() == 2){ // Arcade
                    
                    if(menu.getSettingAlternateColor() == 0){
                        RenderSystem.setShaderTexture(0, CasinoKeeper.TEXTURE_PARALLAX_0_LOW); blit(matrix, leftPos + 18, topPos + 16-6, 58, 93, 140, 70-6);
                    }
                    if(menu.getSettingAlternateColor() == 1){
                        RenderSystem.setShaderTexture(0, CasinoKeeper.TEXTURE_PARALLAX_1_LOW); blit(matrix, leftPos + 18, topPos + 16-6, 58, 93, 140, 70-6);
                    }
                    if(menu.getSettingAlternateColor() == 2){
                        RenderSystem.setShaderTexture(0, CasinoKeeper.TEXTURE_PARALLAX_2_LOW); blit(matrix, leftPos + 18, topPos + 16-6, 58, 93, 140, 70-6);
                    }
                    if(menu.getSettingAlternateColor() == 3){
                        RenderSystem.setShaderTexture(0, CasinoKeeper.TEXTURE_PARALLAX_3_LOW); blit(matrix, leftPos + 18, topPos + 16-6, 58, 93, 140, 70-6);
                    }
                    if(menu.getSettingAlternateColor() == 4){
                        RenderSystem.setShaderTexture(0, CasinoKeeper.TEXTURE_PARALLAX_4_LOW); blit(matrix, leftPos + 18, topPos + 16-6, 58, 93, 140, 70-6);
                    }
                    if(menu.getSettingAlternateColor() == 5){
                        RenderSystem.setShaderTexture(0, CasinoKeeper.TEXTURE_PARALLAX_5_LOW); blit(matrix, leftPos + 18, topPos + 16-6, 58, 93, 140, 70-6);
                    }
                    
                    RenderSystem.setShaderTexture(0, CasinoKeeper.TEXTURE_GROUND_ARCADE);
                    blit(matrix, leftPos + 18, topPos + 16-6, 24, 0, 70, 35);
                    blit(matrix, leftPos + 18+70, topPos + 16-6, 162, 0, 70, 35);
                    blit(matrix, leftPos + 18, topPos + 16+35-12, 24, 221, 70, 35);
                    blit(matrix, leftPos + 18+70, topPos + 16+35-12, 162, 221, 70, 35);
                }
                if(menu.tableID == 3){ // Slot Machine
                    if(menu.getSettingAlternateColor() == 0){
                        RenderSystem.setShaderTexture(0, CasinoKeeper.TEXTURE_SLOTGAME_0);
                        blit(matrix, leftPos + 176/2 - 60, topPos + 2, 0, 0, 120, 50);
                        blit(matrix, leftPos + 176/2 - 60, topPos + 34, 120, 0, 120, 50);
                    }
                    if(menu.getSettingAlternateColor() == 1){
                        RenderSystem.setShaderTexture(0, CasinoKeeper.TEXTURE_SLOTGAME_1);
                        blit(matrix, leftPos + 176/2 - 60, topPos + 2, 0, 0, 120, 50);
                        blit(matrix, leftPos + 176/2 - 60, topPos + 34, 120, 0, 120, 50);
                    }
                    if(menu.getSettingAlternateColor() == 2){
                        RenderSystem.setShaderTexture(0, CasinoKeeper.TEXTURE_SLOTGAME_2);
                        blit(matrix, leftPos + 176/2 - 60, topPos + 2, 0, 0, 120, 50);
                        blit(matrix, leftPos + 176/2 - 60, topPos + 34, 120, 0, 120, 50);
                    }
                    if(menu.getSettingAlternateColor() == 3){
                        RenderSystem.setShaderTexture(0, CasinoKeeper.TEXTURE_SLOTGAME_3);
                        blit(matrix, leftPos + 176/2 - 60, topPos + 2, 0, 0, 120, 50);
                        blit(matrix, leftPos + 176/2 - 60, topPos + 34, 120, 0, 120, 50);
                    }
                    if(menu.getSettingAlternateColor() == 4){
                        RenderSystem.setShaderTexture(0, CasinoKeeper.TEXTURE_SLOTGAME_4);
                        blit(matrix, leftPos + 176/2 - 60, topPos + 2, 0, 0, 120, 50);
                        blit(matrix, leftPos + 176/2 - 60, topPos + 34, 120, 0, 120, 50);
                    }
                    if(menu.getSettingAlternateColor() == 5){
                        RenderSystem.setShaderTexture(0, CasinoKeeper.TEXTURE_SLOTGAME_5);
                        blit(matrix, leftPos + 176/2 - 60, topPos + 2, 0, 0, 120, 50);
                        blit(matrix, leftPos + 176/2 - 60, topPos + 34, 120, 0, 120, 50);
                    }
                }
                ...
                RenderSystem.setShaderTexture(0, GUI_TEXTURE);
                blit(matrix, posX + pos_button_left_5.X + 19 + 6     , posY + pos_button_left_5.Y - 6 + 2, 110, 229, 40, 12);
                blit(matrix, posX + pos_button_left_5.X + 19 + 6 + 40, posY + pos_button_left_5.Y - 6 + 2, 111, 229, 40, 12);
                blit(matrix, posX + pos_button_left_5.X + 19 + 6 + 80, posY + pos_button_left_5.Y - 6 + 2, 112, 229, 40, 12);
            }
            if(page == 3){
                blit(matrix, posX + pos_button_left_1.X, posY + pos_button_left_1.Y - 6, 208, 224, 48, 16);
                blit(matrix, posX + pos_button_left_2.X, posY + pos_button_left_2.Y - 6, 208, 224, 48, 16);
                
                blit(matrix, posX + pos_button_left_1.X + 64+4, posY + pos_button_left_1.Y - 6 + 6, 1, 179, 78, 20);
                
                blit(matrix, posX + 176/2-21, posY + pos_button_left_4.Y - 6 + 2, 110, 243, 42, 12);
                if(hasGambling()) blit(matrix, posX + 176/2-21, posY + pos_button_left_5.Y - 6 + 2, 110, 243, 42, 12);
            }
            if(page == 4){
                blit(matrix, posX + pos_button_left_1.X, posY + pos_button_left_1.Y - 6, 208, 224, 48, 16);
                blit(matrix, posX + pos_button_left_2.X, posY + pos_button_left_2.Y - 6, 208, 224, 48, 16);
                ...
                blit(matrix, posX + 176/2-43, posY + pos_button_left_3.Y - 6 + 2, 110, 243, 42, 12);
                blit(matrix, posX + 176/2-43, posY + pos_button_left_4.Y - 6 + 2, 110, 243, 42, 12);
                blit(matrix, posX + 176/2-43, posY + pos_button_left_5.Y - 6 + 2, 110, 243, 42, 12);
                
                blit(matrix, posX + 176/2+1, posY + pos_button_left_3.Y - 6 + 2, 110, 243, 42, 12);
                blit(matrix, posX + 176/2+1, posY + pos_button_left_4.Y - 6 + 2, 110, 243, 42, 12);
                blit(matrix, posX + 176/2+1, posY + pos_button_left_5.Y - 6 + 2, 110, 243, 42, 12);
            }
            if(page == 5){
                blit(matrix, posX + 176/2-21, posY + pos_button_left_3.Y - 6 + 2, 110, 243, 42, 12);
            }
        }
    ...
    public void commandToggleSettings(int settingID){
        if(settingID == 0){ if(Config.CASINO.config_creative_token.get() && isOP()){  buttonSet.setToggle( 6, menu.setSettingInfiniteToken( !menu.getSettingInfiniteToken()));          } }
        if(settingID == 1){ if(Config.CASINO.config_creative_reward.get() && isOP()){ buttonSet.setToggle( 7, menu.setSettingInfinitePrize( !menu.getSettingInfinitePrize()));          } }
    ...
    private boolean isOP(){
        return !Config.CASINO.config_creative_oponly.get() || this.minecraft.player.getPermissionLevel() > 0;
    }
