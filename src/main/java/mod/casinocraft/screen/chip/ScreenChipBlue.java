...
public class ScreenChipBlue extends ScreenCasino {   // Tetris
    ...
    private void drawTetromino(MatrixStack matrix, int mino, int x, int y) {
    ...
    private void drawTetromino(MatrixStack matrix, int mino, int x, int y, int x1, int y1, int x2, int y2, int x3, int y3, int x4, int y4){
