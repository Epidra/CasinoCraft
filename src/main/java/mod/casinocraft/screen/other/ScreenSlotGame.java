...
public class ScreenSlotGame extends ScreenCasino {   // Slot Game
    ...
    private void drawIcon(MatrixStack matrix, int posX, int posY, int index){
        for(int i = 0; i < 4; i++){
    ...
    private void loadTexture(){
        if(menu.getSettingAlternateColor() == 0) this.minecraft.getTextureManager().bind(CasinoKeeper.TEXTURE_SLOTGAME_0);
        if(menu.getSettingAlternateColor() == 1) this.minecraft.getTextureManager().bind(CasinoKeeper.TEXTURE_SLOTGAME_1);
        if(menu.getSettingAlternateColor() == 2) this.minecraft.getTextureManager().bind(CasinoKeeper.TEXTURE_SLOTGAME_2);
        if(menu.getSettingAlternateColor() == 3) this.minecraft.getTextureManager().bind(CasinoKeeper.TEXTURE_SLOTGAME_3);
        if(menu.getSettingAlternateColor() == 4) this.minecraft.getTextureManager().bind(CasinoKeeper.TEXTURE_SLOTGAME_4);
        if(menu.getSettingAlternateColor() == 5) this.minecraft.getTextureManager().bind(CasinoKeeper.TEXTURE_SLOTGAME_5);
    }
