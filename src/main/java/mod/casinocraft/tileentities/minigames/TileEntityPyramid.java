...
public class TileEntityPyramid extends TileEntityCasino {
	...
	public int getValue(int index){
		if(index == 0) return scorePoints;
		if(index == 1) return scoreLives;
		return selector.X;
	}
    ...
    private void CheckForClearedLine(int id) {
        if(id ==  0) Restart();
        if(id >=  1 && id <  2) if(cards_field[ 1].suit == -1 && cards_field[ 2].suit == -1) scorePoints += 1000;
        if(id >=  3 && id <  5) if(cards_field[ 3].suit == -1 && cards_field[ 4].suit == -1 && cards_field[ 5].suit == -1) scorePoints += 500;
        if(id >=  6 && id <  9) if(cards_field[ 6].suit == -1 && cards_field[ 7].suit == -1 && cards_field[ 8].suit == -1 && cards_field[ 9].suit == -1) scorePoints += 400;
        if(id >= 10 && id < 14) if(cards_field[10].suit == -1 && cards_field[11].suit == -1 && cards_field[12].suit == -1 && cards_field[13].suit == -1 && cards_field[14].suit == -1) scorePoints += 300;
        if(id >= 15 && id < 20) if(cards_field[15].suit == -1 && cards_field[16].suit == -1 && cards_field[17].suit == -1 && cards_field[18].suit == -1 && cards_field[19].suit == -1 && cards_field[20].suit == -1) scorePoints += 200;
        if(id >= 21 && id < 27) if(cards_field[21].suit == -1 && cards_field[22].suit == -1 && cards_field[23].suit == -1 && cards_field[24].suit == -1 && cards_field[25].suit == -1 && cards_field[26].suit == -1 && cards_field[27].suit == -1) scorePoints += 100;
    }
