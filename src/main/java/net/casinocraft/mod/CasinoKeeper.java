...
public class CasinoKeeper {
	...
	public static Item moduleColumns      = new ItemModules("ModuleColumns",      1);
	public static Item moduleMeanMinos      = new ItemModules("ModuleMeanMinos",      1);
	public static Item moduleMysticSquare      = new ItemModules("ModuleMysticSquare",      1);
	public static Item modulePyramid      = new ItemModules("ModulePyramid",      1);
	//public static Item moduleSokoban      = new ItemModules("ModuleSokoban",      1);
	//public static Item moduleSudoku      = new ItemModules("ModuleSudoku",      1);
	public static Item moduleTriPeak      = new ItemModules("ModuleTriPeak",      1);
	...
	public static int guiIDColumns    = 9;
	public static int guiIDMeanMinos    = 10;
	public static int guiIDMysticSquare    = 11;
	public static int guiIDPyramid    = 12;
	public static int guiIDSokoban    = 13;
	public static int guiIDSudoku    = 14;
	public static int guiIDTriPeak    = 15;
	...
	public static void registerBlocks(boolean pre){
		...
		registerItem(moduleColumns,           pre);
		registerItem(moduleMeanMinos,           pre);
		registerItem(moduleMysticSquare,           pre);
		registerItem(modulePyramid,           pre);
		//registerItem(moduleSokoban,           pre);
		//registerItem(moduleSudoku,           pre);
		registerItem(moduleTriPeak,           pre);
	}
	...
	public static void registerEntities(){
		...
		GameRegistry.registerTileEntity(TileEntityColumns .class, "CasinoColumns");
		GameRegistry.registerTileEntity(TileEntityMeanMinos .class, "CasinoMeanMinos");
		GameRegistry.registerTileEntity(TileEntityMysticSquare .class, "CasinoMysticSquare");
		GameRegistry.registerTileEntity(TileEntityPyramid .class, "CasinoPyramid");
		//GameRegistry.registerTileEntity(TileEntitySokoban .class, "CasinoSokoban");
		//GameRegistry.registerTileEntity(TileEntitySudoku .class, "CasinoSudoku");
		GameRegistry.registerTileEntity(TileEntityTriPeak .class, "CasinoTriPeak");
	}
	...
	public static void registerRecipes(){
		...
		GameRegistry.addRecipe(new ItemStack(moduleColumns),      new Object[]{"M", "P", "P", 'P', Items.REDSTONE,    'M', Items.CLAY_BALL});
		GameRegistry.addRecipe(new ItemStack(moduleMeanMinos),    new Object[]{"P", "P", "M", 'P', Items.REDSTONE,    'M', Items.CLAY_BALL});
		GameRegistry.addRecipe(new ItemStack(moduleMysticSquare), new Object[]{"PP", "PM", 'P', Items.PAPER,    'M', Items.DYE});
		GameRegistry.addRecipe(new ItemStack(modulePyramid),      new Object[]{"P ", "P ", "MM", 'P', Items.PAPER,    'M', Items.DYE});
		GameRegistry.addRecipe(new ItemStack(moduleTriPeak),      new Object[]{"MM", "P ", "P ", 'P', Items.PAPER,    'M', Items.DYE});
	}
