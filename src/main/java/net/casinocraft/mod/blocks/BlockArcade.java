        	...
        	if(world.getTileEntity(pos) instanceof TileEntityCasino){
    			...
    			if(player.isSneaking()){
            	  ...
            	  //if(te.arcadeItemStacks[0].getItem() == CasinoKeeper.moduleRoulette)    player.openGui(CasinoCraft.instance, CasinoKeeper.guiIDRoulette,    world, pos.getX(), pos.getY(), pos.getZ());
            		if(te.arcadeItemStacks[0].getItem() == CasinoKeeper.moduleColumns)    
            			player.openGui(CasinoCraft.instance, CasinoKeeper.guiIDColumns,    world, pos.getX(), pos.getY(), pos.getZ());
            		if(te.arcadeItemStacks[0].getItem() == CasinoKeeper.moduleMeanMinos)    
            			player.openGui(CasinoCraft.instance, CasinoKeeper.guiIDMeanMinos,    world, pos.getX(), pos.getY(), pos.getZ());
            		player.addStat(StatList.CRAFTING_TABLE_INTERACTION);
            	}
