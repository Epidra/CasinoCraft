...
public class BlockBlackJack extends BlockContainer {
	...
	public Item getItemDropped(int i, Random random, int j){
		return Item.getItemFromBlock(CasinoCraft.blockBlackJack);
	}
	...
	public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int side, float hitX, float hitY, float hitZ){
		if(world.isRemote){
			...
			FMLNetworkHandler.openGui(player, CasinoCraft.instance, CasinoCraft.guiIDBlackJack, world, x, y, z);
		}
		return true;
	}
	...
	public TileEntity createNewTileEntity(World world, int i){
		return new TileEntityBlackJack();
	}
