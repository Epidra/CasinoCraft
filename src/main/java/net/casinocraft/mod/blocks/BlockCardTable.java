        	...
        	if(world.getTileEntity(pos) instanceof TileEntityCasino){
    			...
    			if(player.isSneaking()){
            	  ...
            	  //if(te.arcadeItemStacks[0].getItem() == CasinoKeeper.moduleRoulette)    player.openGui(CasinoCraft.instance, CasinoKeeper.guiIDRoulette,    world, pos.getX(), pos.getY(), pos.getZ());
            		if(te.arcadeItemStacks[0].getItem() == CasinoKeeper.moduleMysticSquare)   
            			player.openGui(CasinoCraft.instance, CasinoKeeper.guiIDMysticSquare,    world, pos.getX(), pos.getY(), pos.getZ());
            		if(te.arcadeItemStacks[0].getItem() == CasinoKeeper.modulePyramid)   
            			player.openGui(CasinoCraft.instance, CasinoKeeper.guiIDPyramid,    world, pos.getX(), pos.getY(), pos.getZ());
            		if(te.arcadeItemStacks[0].getItem() == CasinoKeeper.moduleTriPeak)  
            			player.openGui(CasinoCraft.instance, CasinoKeeper.guiIDTriPeak,    world, pos.getX(), pos.getY(), pos.getZ());
            		player.addStat(StatList.CRAFTING_TABLE_INTERACTION);
            	}
