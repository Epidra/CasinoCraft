...
public class ContainerMeanMinos extends Container{
    private final TileEntityMeanMinos tileCardTable;
    ...
    public ContainerMeanMinos(InventoryPlayer playerInventory, IInventory blockInventory){
        this.tileCardTable = (TileEntityMeanMinos) blockInventory;
    }
