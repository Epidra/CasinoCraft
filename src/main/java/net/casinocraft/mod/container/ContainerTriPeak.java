...
public class ContainerTriPeak extends Container{
    private final TileEntityTriPeak tileCardTable;
    
    public ContainerTriPeak(InventoryPlayer playerInventory, IInventory blockInventory){
        this.tileCardTable = (TileEntityTriPeak) blockInventory;
    }
