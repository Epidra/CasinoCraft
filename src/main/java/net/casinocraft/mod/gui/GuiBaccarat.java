...
public class GuiBaccarat extends GuiContainer{
    ...
    private final TileEntityBaccarat tileFurnace;
    
    public GuiBaccarat(InventoryPlayer playerInv, IInventory furnaceInv){
        super(new ContainerBaccarat(playerInv, furnaceInv));
        this.playerInventory = playerInv;
        this.tileFurnace = (TileEntityBaccarat) furnaceInv;
        this.xSize = 256;
		this.ySize = 256;
    }
    ...
    protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY){
        ...
        if(tileFurnace.status == 1) this.fontRendererObj.drawString("Natural Draw!", 80, 130, 4210752);
        if(tileFurnace.status == 2) this.fontRendererObj.drawString("continue drawing", 80, 130, 4210752);
        if(tileFurnace.status == 2) { }
        ...
        if(tileFurnace.end){
        	if(tileFurnace.value_dealer <  tileFurnace.value_player) this.fontRendererObj.drawString("The Player Wins!", 80, 150, 4210752);
            if(tileFurnace.value_dealer >  tileFurnace.value_player) this.fontRendererObj.drawString("The House Wins!",  80, 150, 4210752);
            if(tileFurnace.value_dealer == tileFurnace.value_player) this.fontRendererObj.drawString("Tie!",             80, 150, 4210752);
        }
    }
    ...
    protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY){
        ...
        for(int z = 0; z < tileFurnace.cards_player.size(); z++){
        	if(tileFurnace.cards_player.get(z) != null){
        ...
        for(int z = 0; z < tileFurnace.cards_dealer.size(); z++){
        	if(tileFurnace.cards_dealer.get(z) != null){
